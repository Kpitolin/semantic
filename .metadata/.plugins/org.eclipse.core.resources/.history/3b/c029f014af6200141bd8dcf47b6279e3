...
public class Service {
	...
	public JSONObject exploreSimiliratyFromCSV(String pathnameCSV, double seuilJaccard) throws IOException {
        ...
        for (String[] oneData : data) {
			...
			// remplissage de la liste de lien en fonction de l'indice de similarité entre deux noeud
        ...
        //merge des deux liste(deux objets) nodes et links dans l'objet json final objJSON
...
//		try {
//			exploreSimiliratyFromCSV("C:\\Users\\Thomas\\Documents\\4IF\\semantic\\ProjetSE\\matrice_jaccard.csv", 0.6);
//		} catch (IOException e) {
